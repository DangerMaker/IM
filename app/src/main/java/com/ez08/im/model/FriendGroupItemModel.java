...
public class FriendGroupItemModel implements Parcelable {
    ...
    public static class EzContentDataBean implements Parcelable {
        ...
        public static class CommentArrayBean implements Parcelable {
            ...
            public static final Creator<CommentArrayBean> CREATOR = new Creator<CommentArrayBean>() {
                @Override
        ...
        public static final Creator<EzContentDataBean> CREATOR = new Creator<EzContentDataBean>() {
            @Override
    ...
    public static final Creator<FriendGroupItemModel> CREATOR = new Creator<FriendGroupItemModel>() {
        @Override
